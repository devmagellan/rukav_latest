  ...
  return function(t) {
    ...
    var i = function() {
      ...
      return t.prototype.encodedLength = function(t) {
        ...
        for (var e = "", n = 0; n < t.length - 2; n += 3) {
          ...
          e += this._encodeByte(o >>> 18 & 63), e += this._encodeByte(o >>> 12 & 63), e += this._encodeByte(o >>> 6 & 63),
            e += this._encodeByte(o >>> 0 & 63);
        }
        var r = t.length - n;
        if (r > 0) {
          o = t[n] << 16 | (2 === r ? t[n + 1] << 8 : 0);
          e += this._encodeByte(o >>> 18 & 63), e += this._encodeByte(o >>> 12 & 63), e += 2 === r ? this._encodeByte(o >>> 6 & 63) : this._paddingCharacter || "",
        ...
        for (var e = this._getPaddingLength(t), n = t.length - e, o = new Uint8Array(this.maxDecodedLength(n)), r = 0, i = 0, s = 0, c = 0, a = 0, u = 0, h = 0; i < n - 4; i += 4) c = this._decodeChar(t.charCodeAt(i + 0)),
          a = this._decodeChar(t.charCodeAt(i + 1)), u = this._decodeChar(t.charCodeAt(i + 2)),
          h = this._decodeChar(t.charCodeAt(i + 3)), o[r++] = c << 2 | a >>> 4, o[r++] = a << 4 | u >>> 2,
          o[r++] = u << 6 | h, s |= 256 & c, s |= 256 & a, s |= 256 & u, s |= 256 & h;
        if (i < n - 1 && (c = this._decodeChar(t.charCodeAt(i)), a = this._decodeChar(t.charCodeAt(i + 1)),
          o[r++] = c << 2 | a >>> 4, s |= 256 & c, s |= 256 & a), i < n - 2 && (u = this._decodeChar(t.charCodeAt(i + 2)),
          o[r++] = a << 4 | u >>> 2, s |= 256 & u), i < n - 3 && (h = this._decodeChar(t.charCodeAt(i + 3)),
          o[r++] = u << 6 | h, s |= 256 & h), 0 !== s) throw new Error("Base64Coder: incorrect characters for decoding");
        return o;
      }, t.prototype._encodeByte = function(t) {
        var e = t;
        return e += 65, e += 25 - t >>> 8 & 6, e += 51 - t >>> 8 & -75, e += 61 - t >>> 8 & -15,
          e += 62 - t >>> 8 & 3, String.fromCharCode(e);
      }, t.prototype._decodeChar = function(t) {
        var e = 256;
        return e += (42 - t & t - 44) >>> 8 & -256 + t - 43 + 62, e += (46 - t & t - 48) >>> 8 & -256 + t - 47 + 63,
          e += (47 - t & t - 58) >>> 8 & -256 + t - 48 + 52, e += (64 - t & t - 91) >>> 8 & -256 + t - 65 + 0,
    ...
    var c = function(t) {
      ...
      return r(e, t), e.prototype._encodeByte = function(t) {
        var e = t;
        return e += 65, e += 25 - t >>> 8 & 6, e += 51 - t >>> 8 & -75, e += 61 - t >>> 8 & -13,
          e += 62 - t >>> 8 & 49, String.fromCharCode(e);
      }, e.prototype._decodeChar = function(t) {
        var e = 256;
        return e += (44 - t & t - 46) >>> 8 & -256 + t - 45 + 62, e += (94 - t & t - 96) >>> 8 & -256 + t - 95 + 63,
          e += (47 - t & t - 58) >>> 8 & -256 + t - 48 + 52, e += (64 - t & t - 91) >>> 8 & -256 + t - 65 + 0,
          e += (96 - t & t - 123) >>> 8 & -256 + t - 97 + 26;
      }, e;
    }(i);
    ...
    e.encode = function(t) {
      for (var e = new Uint8Array(r(t)), n = 0, o = 0; o < t.length; o++) {
        ...
        i < 128 ? e[n++] = i : i < 2048 ? (e[n++] = 192 | i >> 6, e[n++] = 128 | 63 & i) : i < 55296 ? (e[n++] = 224 | i >> 12,
          e[n++] = 128 | i >> 6 & 63, e[n++] = 128 | 63 & i) : (o++, i = (1023 & i) << 10,
          i |= 1023 & t.charCodeAt(o), i += 65536, e[n++] = 240 | i >> 18, e[n++] = 128 | i >> 12 & 63,
          e[n++] = 128 | i >> 6 & 63, e[n++] = 128 | 63 & i);
      }
      return e;
    ...
    var o = function() {
    ...
    }(), r = new o("_pusher_script_", "Pusher.ScriptReceivers"), i = {
      VERSION: "6.0.3",
      PROTOCOL: 7,
      wsPort: 80,
      wssPort: 443,
      ...
      return t.prototype.load = function(t, e, n) {
        ...
        if (o.loading[t] && o.loading[t].length > 0) o.loading[t].push(n); else {
          o.loading[t] = [ n ];
          var r = we.createScriptRequest(o.getPath(t, e)), i = o.receivers.create(function(e) {
    ...
    }(), c = new o("_pusher_dependencies", "Pusher.DependenciesReceivers"), a = new s({
      cdn_http: i.cdn_http,
    ...
    function N(t) {
      return e = function(t) {
        return "object" == typeof t && (t = H(t)), encodeURIComponent((e = t.toString(),
          b(g(e))));
        var e;
      }, n = {}, L(t, function(t, o) {
        n[o] = e(t);
      ...
      try {
        ...
        return JSON.stringify((e = [], n = [], function t(o, r) {
          ...
          switch (typeof o) {
            case "object":
              if (!o) return null;
              for (i = 0; i < e.length; i += 1) if (e[i] === o) return {
                $ref: n[i]
              };
              if (e.push(o), n.push(r), "[object Array]" === Object.prototype.toString.apply(o)) for (c = [],
                                                                                                        i = 0; i < o.length; i += 1) c[i] = t(o[i], r + "[" + i + "]"); else for (s in c = {},
                o) Object.prototype.hasOwnProperty.call(o, s) && (c[s] = t(o[s], r + "[" + JSON.stringify(s) + "]"));
              return c;
    ...
    var q = new (function() {
      ...
      var o, r = this;
      for (var i in (o = we.createXHR()).open("POST", r.options.authEndpoint, !0), o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"),
        this.authOptions.headers) o.setRequestHeader(i, this.authOptions.headers[i]);
      return o.onreadystatechange = function() {
        if (4 === o.readyState) if (200 === o.status) {
          ...
          q.error("Unable to retrieve auth string from auth endpoint - received status " + o.status + " from " + r.options.authEndpoint + ". Clients must be authenticated to join private or presence channels. " + i),
            n(!0, o.status);
        }
      ...
      return t.prototype.send = function(t) {
        ...
        e.script = document.createElement("script"), e.script.id = t.id, e.script.src = e.src,
          e.script.type = "text/javascript", e.script.charset = "UTF-8", e.script.addEventListener ? (e.script.onerror = function() {
          t.callback(n);
          ...
          e.errorScript.id = t.id + "_error", e.errorScript.text = t.name + "('" + n + "');",
      ...
      return t.prototype.send = function(t) {
        if (!this.request) {
          var e = M(this.data), n = this.url + "/" + t.number + "?" + e;
      ...
      getAgent: function(t, e) {
        return function(n, o) {
          var i = "http" + (e ? "s" : "") + "://" + (t.host || t.options.host) + t.options.path, s = we.createJSONPRequest(i, n), c = we.ScriptReceivers.create(function(e, n) {
    ...
    var tt = function() {
      ...
      function e(e, n, o, r, i) {
        ...
        return s.initialize = we.transportConnectionInitializer, s.hooks = e, s.name = n,
          s.priority = o, s.key = r, s.options = i, s.state = "new", s.timeline = i.timeline,
          s.activityTimeout = i.activityTimeout, s.id = s.timeline.generateUniqueID(), s;
      }
    ...
    }, lt = new ot(P({}, st, pt)), ft = new ot(P({}, ct, pt));
    ...
    var dt = ut, yt = function() {
      ...
      function t(t, e, n) {
        this.manager = t, this.transport = e, this.minPingDelay = n.minPingDelay, this.maxPingDelay = n.maxPingDelay,
      ...
      function e(e, n) {
        ...
        return o.id = e, o.transport = n, o.activityTimeout = n.activityTimeout, o.bindListeners(),
          o;
      }
      ...
      return t.prototype.close = function() {
        ...
        this.onMessage = function(e) {
          ...
          t.unbindListeners();
          var n = mt.getCloseAction(e) || "backoff", o = mt.getCloseError(e);
          t.finish(n, {
            error: o
          });
      ...
      function e(e, n) {
        ...
        return o.name = e, o.pusher = n, o.subscribed = !1, o.subscriptionPending = !1,
          o.subscriptionCancelled = !1, o;
      }
      ...
      return t.prototype.get = function(t) {
        ...
        return null === this.get(t.user_id) && this.count++, this.members[t.user_id] = t.user_info,
          this.get(t.user_id);
      ...
      return Ht(e, t), e.prototype.authorize = function(e, n) {
        ...
        t.prototype.authorize.call(this, e, function(t, e) {
          if (!t) {
            if (void 0 === (e = e).channel_data) {
              ...
              return q.error("Invalid auth response for channel '" + o.name + "',expected 'channel_data' field. " + r),
        ...
        this.subscriptionPending = !1, this.subscribed = !0, this.subscriptionCancelled ? this.pusher.unsubscribe(this.name) : (this.members.onSubscription(t.data),
          this.emit("pusher:subscription_succeeded", this.members));
      }, e.prototype.disconnect = function() {
        this.members.reset(), t.prototype.disconnect.call(this);
      }, e;
    }(Nt), Bt = n(1), zt = n(0), Ut = function() {
      var t = function(e, n) {
        return (t = Object.setPrototypeOf || {
          __proto__: []
        } instanceof Array && function(t, e) {
      ...
      return Ut(e, t), e.prototype.authorize = function(e, n) {
        ...
        t.prototype.authorize.call(this, e, function(t, e) {
          if (t) n(!0, e); else {
            ...
            if (r) o.key = Object(zt.decode)(r), delete e.shared_secret, n(!1, e); else {
        ...
        if (this.key) if (e.ciphertext && e.nonce) {
          ...
          if (o.length < this.nacl.secretbox.overheadLength) q.error("Expected encrypted event ciphertext length to be " + this.nacl.secretbox.overheadLength + ", got: " + o.length); else {
            var r = Object(zt.decode)(e.nonce);
            if (r.length < this.nacl.secretbox.nonceLength) q.error("Expected encrypted event nonce length to be " + this.nacl.secretbox.nonceLength + ", got: " + r.length); else {
              var i = this.nacl.secretbox.open(o, r, this.key);
              if (null === i) return q.debug("Failed to decrypt an event, probably because it was encrypted with a different key. Fetching a new key from the authEndpoint..."),
        ...
        } else q.error("Unexpected format for encrypted event, expected object with `ciphertext` and `nonce` fields, got: " + e); else q.debug("Received encrypted event before key has been retrieved from the authEndpoint");
      ...
      function e(e, n) {
        var o = t.call(this) || this;
        o.state = "initialized", o.connection = null, o.key = e, o.options = n, o.timeline = o.options.timeline,
          o.usingTLS = o.options.useTLS, o.errorCallbacks = o.buildErrorCallbacks(), o.connectionCallbacks = o.buildConnectionCallbacks(o.errorCallbacks),
      ...
      return Jt(e, t), e.prototype.connect = function() {
        ...
        return P({}, t, {
          connected: function(t) {
            e.activityTimeout = Math.min(e.options.activityTimeout, t.activityTimeout, t.connection.activityTimeout || 1 / 0),
              e.clearUnavailableTimer(), e.setConnection(t.connection), e.socket_id = e.connection.id,
        ...
        if (this.state = t, n !== t) {
          var o = t;
          "connected" === o && (o += " with new socket ID " + e.socket_id), q.debug("State changed", n + " -> " + o),
            this.timeline.info({
              state: t,
              params: e
    ...
    var Gt = {
      ...
      function t(t, e) {
        this.strategies = t, this.loop = Boolean(e.loop), this.failFast = Boolean(e.failFast),
          this.timeout = e.timeout, this.timeoutLimit = e.timeoutLimit;
      }
      return t.prototype.isSupported = function() {
        ...
        var n = this, o = this.strategies, r = 0, i = this.timeout, s = null, c = function(a, u) {
          u ? e(null, u) : (r += 1, n.loop && (r %= o.length), r < o.length ? (i && (i *= 2,
          n.timeoutLimit && (i = Math.min(i, n.timeoutLimit))), s = n.tryStrategy(o[r], t, {
            timeout: i,
            failFast: n.failFast
          }, c)) : e(!0));
        };
    ...
    var Kt = function() {
      function t(t, e, n) {
        this.strategy = t, this.transports = e, this.ttl = n.ttl || 18e5, this.usingTLS = n.useTLS,
      ...
      return t.prototype.isSupported = function() {
        ...
        var s = T.now(), c = r.pop().connect(t, function o(i, a) {
    ...
    var ee = function() {
      ...
      return t.prototype.isSupported = function() {
        ...
        var n, o = this.strategy, r = new k(this.options.delay, function() {
          n = o.connect(t, e);
        });
        return {
          abort: function() {
    ...
    var ie, se = function(t, e, n) {
      ...
      var i, s = Object.assign({}, e, {
        ...
        minPingDelay: 1e4,
        maxPingDelay: t.activityTimeout
      }), l = r("ws", "ws", 3, s, h), f = r("wss", "ws", 3, c, h), d = r("sockjs", "sockjs", 1, a), y = r("xhr_streaming", "xhr_streaming", 1, a, p), g = r("xdr_streaming", "xdr_streaming", 1, a, p), v = r("xhr_polling", "xhr_polling", 1, a), b = r("xdr_polling", "xdr_polling", 1, a), m = new Vt([ l ], u), w = new Vt([ f ], u), _ = new Vt([ d ], u), S = new Vt([ new ne(re(y), y, g) ], u), k = new Vt([ new ne(re(v), v, b) ], u), C = new Vt([ new ne(re(S), new Yt([ S, new ee(k, {
        delay: 4e3
      }) ]), k) ], u), T = new ne(re(C), C, _);
      ...
      getRequest: function(t) {
        ...
        return e.ontimeout = function() {
          ...
          e.responseText && e.responseText.length > 0 && t.onChunk(200, e.responseText), t.emit("finished", 200),
            t.close();
        }, e;
      },
      ...
      return ae(e, t), e.prototype.start = function(t) {
        ...
        this.position = 0, this.xhr = this.hooks.getRequest(this), this.unloader = function() {
          e.close();
        }, we.addUnloadListener(this.unloader), this.xhr.open(this.method, this.url, !0),
        this.xhr.setRequestHeader && this.xhr.setRequestHeader("Content-Type", "application/json"),
          this.xhr.send(t);
      }, e.prototype.close = function() {
        this.unloader && (we.removeUnloadListener(this.unloader), this.unloader = null),
    ...
    var de, ye = function() {
      ...
      return t.prototype.send = function(t) {
        ...
        try {
          return we.createSocketRequest("POST", le((e = this.location, n = this.session, e.base + "/" + n + "/xhr_send"))).start(t),
            !0;
        } catch (t) {
          return !1;
        }
        ...
        var e;
        if (200 === t.status) switch (this.readyState === he.OPEN && this.onActivity(),
          t.data.slice(0, 1)) {
          case "o":
        ...
        var e, n, o;
        this.readyState === he.CONNECTING ? (t && t.hostname && (this.location.base = (e = this.location.base,
          n = t.hostname, (o = /(https?:\/\/)([^\/:]+)((\/|:)?.*)/.exec(e))[1] + n + o[3])),
          this.readyState = he.OPEN, this.onopen && this.onopen()) : this.onClose(1006, "Server lost session", !0);
        ...
        var t = this;
        this.stream = we.createSocketRequest("POST", le(this.hooks.getReceiveURL(this.location, this.session))),
      ...
      getRequest: function(t) {
        ...
        return e.onreadystatechange = e.onprogress = function() {
          switch (e.readyState) {
            ...
            case 4:
              e.responseText && e.responseText.length > 0 && t.onChunk(e.status, e.responseText),
                t.emit("finished", e.status), t.close();
          }
        }, e;
      },
      abortRequest: function(t) {
      ...
      transportConnectionInitializer: function() {
        ...
        t.timeline.info(t.buildTimelineMessage({
          ...
          a.load(t.hooks.file, {
            ...
            t.hooks.isInitialized() ? (t.changeState("initialized"), n(!0)) : (e && t.onError(e),
              t.onClose(), n(!1));
          })) : t.onClose();
      },
      HTTPFactory: me,
    ...
    var _e = de, Se = function() {
      function t(t, e, n) {
        this.key = t, this.session = e, this.events = [], this.options = n || {}, this.sent = 0,
          this.uniqueID = 0;
      }
      ...
      return t.prototype.isSupported = function() {
        ...
        var o = !1, r = this.transport.createConnection(this.name, this.priority, this.options.key, this.options), i = null, s = function() {
        ...
        return r.bind("initialized", s), r.bind("open", c), r.bind("error", a), r.bind("closed", u),
          r.initialize(), {
          abort: function() {
    ...
    var Te = we.Transports, Pe = function(t, e, n, o, r, i) {
      var s, c = Te[n];
      if (!c) throw new At(n);
    ...
    var je = function() {
      function t(e, n) {
        ...
        "disableStats" in n && q.warn("The disableStats option is deprecated in favor of enableStats"),
          this.key = e, this.config = (r = {
          ...
          useTLS: Ae(o),
          wsHost: Le(o)
        }, "auth" in o && (r.auth = o.auth), "authorizer" in o && (r.authorizer = o.authorizer),
        "disabledTransports" in o && (r.disabledTransports = o.disabledTransports), "enabledTransports" in o && (r.enabledTransports = o.enabledTransports),
        "ignoreNullOrigin" in o && (r.ignoreNullOrigin = o.ignoreNullOrigin), "timelineParams" in o && (r.timelineParams = o.timelineParams),
        "nacl" in o && (r.nacl = o.nacl), r), this.channels = Gt.createChannels(), this.global_emitter = new tt(),
          this.sessionID = Math.floor(1e9 * Math.random()), this.timeline = new Se(this.key, this.sessionID, {
      ...
      }, t.instances = [], t.isReady = !1, t.logToConsole = !1, t.Runtime = we, t.ScriptReceivers = we.ScriptReceivers,
        t.DependenciesReceivers = we.DependenciesReceivers, t.auth_callbacks = we.auth_callbacks,
        t;
    }(), Ie = e.default = je;
    we.setup(je);
  } ]);
