      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="breadcrumbs">
            ...
            <li>Редактировать обьявление</li>
          </ul>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="add_advert_block_wrapper">
            ...
            <div class="add_advert_block_input1">
              ...
              <input type="text" name="category_ads" placeholder="{{$category}}" class="select_category" required readonly>
        ...
        <div class="col-sm-12">
          <div class="add_advert_block_wrapper">
            ...
            <div class="select_location_block">
              ...
              <label for="select_adress" class="choose_location" id="select_adress_label">Выбрать место</label>
