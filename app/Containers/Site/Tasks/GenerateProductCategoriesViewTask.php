...
class GenerateProductCategoriesViewTask extends Task
{
    ...
    public function __construct(AdminMenuRepository $repository)
    {
		...
		$this->rootCatsArrayInit=\App\Containers\Site\Models\ProductCategory::where('parent_id',0)->pluck('id')->toArray();
		$this->rootCatsArray=\App\Containers\Site\Models\ProductCategory::whereIn('parent_id',$this->rootCatsArrayInit)->pluck('id')->toArray();
    }
