        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="role_create btn btn-primary waves-effect waves-themed">Сохранить</button>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div id="panel-1" class="panel">
                                ...
                                <div class="panel-container show">
                                    <div class="panel-content">
                                        <div class="panel-tag">
                                            <div class="demo">
                                                <button type="button" class="createNewRole btn btn-lg btn-primary waves-effect waves-themed" data-toggle="modal" data-target=".default-example-modal-center">
    ...
    <script>
        ...
        $('.role_change').click(function(){
            ...
            $.ajax({
                ...
                data: {name: name,description:description,id:role_id},
                beforeSend: function() {
                },
                complete: function() {
        ...
        $('.createNewRole').click(function(){
            $('.role_create').removeClass('role_change');
        })
