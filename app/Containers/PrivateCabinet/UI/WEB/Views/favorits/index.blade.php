...
@section('content')
  ...
  <main>
    ...
    <div class="choosen" id="favorites">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
        ...
        <div class="row">
          <div class="col-sm-12 d-flex prophile_tab_column">
            ...
            <a href="/private_cabinet/screen/messages" class="choosen_tab_title tab_message" onclick="reloadMessages()">
              <div class="choosen_tab_icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/private_cabinet/screen/favorits" class="choosen_tab_title tab_active tab_favorites">
              <div class="choosen_tab_icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/private_cabinet/screen/my_profile" class="choosen_tab_title tab_my_profile">
              <div class="choosen_tab_icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0)">
        ...
        <div class="row">
		  ...
		  @if(count($favorits)<1)
			  <br>
              <h3 style="color:grey;margin-top:150px">Вы еще не добавляли объявления в Избранное</h3>
              @endif
            ...
            <div class="choosen_item-wrapper d-flex" id="favorite_{{$favorit->id}}">
             ...
             @elseif(null!=$favorit->age)
              ...
              <div class="choosen_button-wrapper d-flex flex-row flex-wrap align-items-center justify-content-between">
                ...
                <button onclick="deleteFromFavorites('{{$favorit->id}}')" class="choosen_button ml-auto">
