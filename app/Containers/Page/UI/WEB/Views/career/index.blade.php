      ...
      <div class="row" style="margin-top:50px">
        ...
        <h3 style="font-weight:600">Нам нужны специалисты таких направлений</h3>
          ...
          <ul style="margin-top:50px;color:#A269F7">
            ...
            <li>> Менеджер по работе с клиентами через социальные сети</li>
            <li>> Системный администратор</li>
            <li>> Менеджер технической поддержки</li>
            <li>> Оператор Call центра, специалист технической поддержки</li>
            <li>> Менеджер по работе с клиентами на веб портале по недвижимости</li>
          </ul>
        </div>
        <div class="col-md-5">
